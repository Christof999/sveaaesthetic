...
export default function AdminLogin() {
  ...
  useEffect(() => {
    ...
    if (params.get('registered') === 'true') {
      setError('');
      // Zeige Erfolgsmeldung könnte hier hinzugefügt werden
    }
  }, []);
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      const errorMessage = err.message || 'Google-Anmeldung fehlgeschlagen. Bitte versuche es erneut.';
        ...
        <div className="border-t border-gray-200 pt-8">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full py-2 border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
